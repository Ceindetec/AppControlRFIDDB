...
CREATE TABLE `area` (
  ...
  `are_estado_id` int(11) NOT NULL COMMENT 'Campo que registra el estado de la area',
  PRIMARY KEY (`are_id`),
...
CREATE TABLE `estado` (
  ...
  `sta_estado_id` int(11) NOT NULL COMMENT 'Campo que registra el estado del estado',
  PRIMARY KEY (`sta_id`),
...
CREATE TABLE `tipo_autorizacion` (
  ...
  `taut_estado_id` int(11) DEFAULT NULL COMMENT 'Campo que registra el estado del tipo de autorizacion',
  PRIMARY KEY (`taut_id`),
...
CREATE TABLE `tipo_usuario` (
  ...
  `tusu_estado_id` int(11) NOT NULL COMMENT 'Campo que registra el estado del tipo de usuario',
  PRIMARY KEY (`tusu_id`),
